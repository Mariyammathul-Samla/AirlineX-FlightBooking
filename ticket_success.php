...
#contBtn:hover {
	...
	<body>
		...
		<div>
			<ul>
				...
				<li><a href="about.php"><i class="fa fa-phone" aria-hidden="true"></i> Contact Us</a></li>
    ...
    <div id="lower-side">
        <p id="message">
		<!-- <h2>BOOKING SUCCESSFUL</h2> -->
		<h5>Your payment of &#x20b9; <?php echo $_SESSION['total_amount']; ?> has been received.<br><br> Your PNR is <strong><?php echo $_SESSION['pnr'];?></strong>. Your tickets have been booked successfully.</h5>
        </p>
        <a href="customer_homepage.php" id="contBtn">Continue</a>
    </div>
</div>
	</body>
</html>